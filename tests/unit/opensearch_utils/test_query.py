...
class TestQuery(unittest.TestCase):
    ...
    def test_get_name_both_dates(self):
        """
        test that the query_dsl method correctly returns the formatted query. This tests the flow where there is both a start
        and end date parameter.
        """
        ## Arrange ##
    ...
    def test_get_name_no_start_date(self):
        """
        test that the query_dsl method correctly returns the formatted query. This tests the flow where there is an end date
        parameter, but no start date parameter
        """
        ## Arrange ##
    ...
    def test_get_name_no_end_date(self):
        """
        test that the query_dsl method correctly returns the formatted query. This tests the flow where there is an a start date
        parameter, but no end date parameter
        """
        ## Arrange ##
    ...
    def test_get_name_no_date(self):
        """
        test that the query_dsl method correctly returns the formatted query. This tests the flow where there is neither a start
        or end date parameter.
        """
        ## Arrange ##
